...
First, I wrote a python script to pull a list of movie names, release dates, and wiki links from ![here](https://en.wikipedia.org/wiki/2015_in_film). Then, I gathered wiki views data from ![](http://stats.grok.se/) using the pyhton requests module. Here's a few popular movies:
